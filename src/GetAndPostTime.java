		...
		if (temp != null) {
			...
			//	System.out.println(data1+"\t data1");
				...
				if(function.equals("M_Snapshot"))
				{
					...
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+"No Point In This Time_Series!"+"#";}
					else
						outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.snapshot(ts).toText()+"#";
				}
				if(function.equals("M_Slice"))
				{
					...
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.slice(fromTime, toTime).toGeoString()+"#";
				}
				if(function.equals("M_Atomize"))
				{
					long ts = Long.parseLong(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.atomize(ts).toGeoString()+"#";
				}
				if(function.equals("M_Lattice"))
				{
					long ts = Long.parseLong(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.lattice(ts).toGeoString()+"#";
				}if(function.equals("M_First"))
				{
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.first().toGeoString()+"#";
				}if(function.equals("M_Last"))
				{
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.last().toGeoString()+"#";
				}if(function.equals("M_At"))
				{
					int ts = Integer.parseInt(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.at(ts).toGeoString()+"#";
				}if(function.equals("M_NumOf"))
				{
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.numOf()+"#";
				}
				if(function.equals("M_VeolocityAtTime"))
				{
					long ts = Long.parseLong(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.veolocityAtTimeTime(ts)+"#";
				}
				if(function.equals("M_AccelerationAtTime"))
				{
					long ts = Long.parseLong(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.accelerationAtTimeTime(ts)+"#";
				}
				if(function.equals("M_TimeAtDistance"))
				{
					double ts = Double.parseDouble(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.timeAtDistance(ts)+"#";
				}
				if(function.equals("M_TimeToDistance"))
				{
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.timeToDistance().toGeoString()+"#";
				}
				if(function.equals("M_TimeAtCummulativer"))
				{
					double ts = Double.parseDouble(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.timeAtCummulativeDistance(ts)+"#";
				}
				if(function.equals("M_SnapToGrid"))
				{
					double ts = Double.parseDouble(parameter.split("@")[0]);
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.snapToGrid(ts)+"#";
				}
				if(function.equals("M_BBox"))
				{
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.bbox().toText()+"#";
				}
				if(function.equals("M_BTime"))
				{
					outputString = outputString+function+"@"+ sss[i].replace("\"", "")+"@"+type+"@"+mg.btime().toGeoString()+"#";
				}
			}
