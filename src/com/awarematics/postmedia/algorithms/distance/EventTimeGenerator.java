	...
	if (geometry1.intersects(geometry2)) {
			...
			for (int k = 0; k < pp.length; k++) {
				for (int ii = 1; ii < mg1.numOf(); ii++) {
					...
					if ((calDistance(mg1.getCoords()[ii], pp[k]) + calDistance(mg1.getCoords()[ii - 1], pp[k])) - calDistance(
							mg1.getCoords()[ii], mg1.getCoords()[ii - 1])<0.0000001) {
						long newTime = (long) ((mg1.getTimes()[ii] - mg1.getTimes()[ii - 1])
								* calDistance(mg1.getCoords()[ii - 1], pp[k])/ calDistance(mg1.getCoords()[ii], mg1.getCoords()[ii - 1])
								+ mg1.getTimes()[ii - 1]);
