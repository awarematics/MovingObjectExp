...
<body>
	...
	<div
		...
		<form method="post">
			<br /> <span style="margin-left:170px;">M_Time Function </span> <br />
			...
			<div
				...
				<span>Select function</span> <select id="type3">
					<option value="">--</option>
					<option value="fun1">M_LCSS</option>
					<option value="fun2">M_LCVS</option>
					<option value="fun3">M_LCVSMBT</option>
					<option value="fun4">M_LCVSMBR</option>
					<option value="fun5">M_TrajHausdorff</option>
					<option value="fun6">M_Hausdorff</option>					
				</select>
				<p>
				<div id="delta" style="display:none">
					Please input parameter delta: <input type="text" id="deltavalue"
						value="" />
				</div>
				<div id="epsilon" style="display:none">
					Please input parameter epsilon: <input type="text" id="epsilonvalue" value="" />
					<p>
						Please input parameter delta: <input type="text" id="deltavalue2" value="">
				</div>
			</div>
	...
	<script>
		...
		function createTimes() {
			...
			var parameter2 = document.getElementById("epsilonvalue");
			var parameter3 = document.getElementById("deltavalue2");
			//alert(options.text());
