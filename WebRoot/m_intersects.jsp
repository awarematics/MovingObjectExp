...
<body>
	...
	<div
		...
		<form method="post">
			<br /> <span style="margin-left:170px;">M_Intersects </span> <br />
			...
			<input type="button" value="Show System Data List!" style="margin-left:25px;"
				...
				class="btn_2k3" onclick="javascript:window.open('m_intersects_input.jsp');" />
			<hr size="1" color="#008B8B"></hr>
			<ul id="showUl"></ul>
			<hr size="1" color="#008B8B"></hr>
			<div
				...
				<span>Select function</span> <select id="type6">
					<option value="">--</option>
					<option value="fun9">MGeometry_Intersects</option>	
					<option value="fun10">Secondo_Intersects</option>				
				</select>
				<p>
			</div>
