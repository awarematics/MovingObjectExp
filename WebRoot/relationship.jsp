...
<body>
	...
	<div
		...
		<form method="post">
			<br /> <span style="margin-left:170px;">Relationship </span> <br />
			...
			<div
				...
				<span>Select function</span> <select id="type6">
					<option value="">--</option>
					<option value="fun1">M_Equal</option>
					<option value="fun2">M_Meet</option>
					<option value="fun3">M_Intersects</option>
					<option value="fun4">M_Inside</option>
					<option value="fun5">M_Contains</option>
					<option value="fun6">M_Disjoint</option>
					<option value="fun7">M_EvenTime</option>
					<option value="fun8">M_Overlaps</option>
					<option value="fun9">M_Relationship</option>					
				</select>
				<p>
			</div>
